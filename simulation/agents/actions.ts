...
const FOOD_SEARCH_RADIUS = 8;
const WATER_SEARCH_RADIUS = 8;
const SOCIAL_SEARCH_RADIUS = 6;
const HELP_SEARCH_RADIUS = 4;
...
const COAST_HUNT_RADIUS = 8;
const RIVER_FISH_RADIUS = 6;
